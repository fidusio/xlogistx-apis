...
public class AIAPI
     ...
     * @return the pending http callback
     */
    public HTTPCallback<NVGenericMap, NVGenericMap> asyncCompletion(String aiModel, String prompt, int maxTokens, String skillContent, ConsumerCallback<NVGenericMap> callback) {
